class ResultTicketFactory {
    static descriptions = {
        ...
        'PNC03': 'Поширені типографські помилки: дефіс (-, U+002D) або довге тире (—, U+2014) замість тире (–, U+2013); три крапки окремими символами (., U+002E), замість одного (…, U+2026); ASCII-апостроф (\', U+0027) замість звичайного (’, U+2019).',
