...
namespace DiplomaAnalysis.Services.Pronouns;

public sealed class PronounsService : IAnalysisService
{
    private readonly WordprocessingDocument _document;

    public PronounsService(Stream data)
    {
