class ResultTicketFactory {
    static descriptions = {
        ...
        'LAY02': 'Всі документи, крім загальної титульної сторінки та відомості, повинні мати ліве поле у 3 см та всі інші поля у 2 см.',
        ...
        'PNC04': 'Між словами у тексті завжди ставиться лише один пробіл.',
        ...
        'TBL05': 'Схоже, що заголовок з продовженням таблиці знаходиться на тій же сторінці, що і початок таблиці.',
        'IMG01': 'Кожен рисунок підписується наступним рядком відразу після нього. Підпис має наступний формат: "Рис. [номер розділу].[номер за порядком у межах розділу]. Назва рисунку". В кінці підпису крапка не ставиться.',
