class ResultTicketFactory {
    static descriptions = {
        ...
        'ORT01': 'За <a href="https://bit.ly/3xMcJdt">новим правописом</a> треба писати: про<strong>є</strong>кт, а не проект; компонент "веб" разом з наступним словом, наприклад, <strong>веб</strong>сайт, а не веб сайт або веб-сайт.'
    };
